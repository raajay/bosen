...
namespace petuum {
  ...
  public:
    ...
    SSPClientRow(int32_t clock, int32_t global_version, AbstractRow* row_data, bool use_ref_count):
    ...
    void SetGlobalVersion(int32_t version) {
      ...
      CHECK_GE(version, global_version_) << "New version is less than existing version of the row.";
